...
import { Sparkles, PhoneCall, Heart, Award, Shield } from "lucide-react";
...
export default function AboutPage() {
  return (
    <div className="relative z-10 min-h-screen flex flex-col">
      <title>About Us — NexaGrowth</title>
      <meta name="description" content="Learn about NexaGrowth's mission, our values, and the team driving digital marketing and web development in Pakistan." />
      <Background />
      ...
      <header className="page-hero w-full">
        <div className="mx-auto max-w-[1100px] px-6 py-16 text-center flex flex-col items-center">
          ...
          <p className="text-[15px] sm:text-[17px] md:text-[18px] font-normal text-foreground/60 leading-[1.7] max-w-[640px] fade-rise-subheadline">
            Learn about our mission, our values, and the team driving high-performance digital marketing, technical SEO, and conversion web development across Pakistan.
          </p>
        </div>
      </header>
      ...
      <main className="flex-1 w-full max-w-[820px] mx-auto px-6 py-12 pb-24 relative z-20">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-[15px] text-foreground/85 leading-relaxed mb-6 italic">
                "I started this agency because I saw too many businesses in Pakistan wasting money on outdated marketing. Boosting posts is not a strategy. We build technical SEO assets, high-converting web storefronts, and precision-targeted paid funnels that bring actual, measurable ROAS."
              </p>
        ...
        >
          ...
          <p className="text-[15px] text-foreground/80 leading-relaxed mb-4">
            Founded by Talha, a Computer Science student and full-stack developer who turned his technical expertise towards digital marketing. Starting as a freelance web engineer in Multan, Talha observed a recurring theme: clients were hiring programmers to code websites, but their stores were empty because they lacked any SEO, search rankings, conversions, or targeting strategies.
          </p>
          <p className="text-[15px] text-foreground/80 leading-relaxed">
            NexaGrowth was created to bridge this exact void. We combine solid, performance-grade software engineering (clean React code, speed-optimization, conversion layouts) with data-backed creative marketing (precision audience segmentation, keyword targeting, and viral content briefs). We operate as your dedicated digital growth partner.
          </p>
        </section>
        ...
        >
          ...
          <p className="text-[15px] text-foreground/80 leading-relaxed mb-4">
            To provide Pakistani businesses with a clean, elite, metrics-focused alternative to generic marketing agencies. Too many local agencies rely on " vanity metrics" — likes, impressions, and video views that don't bring a single customer in. 
          </p>
          <p className="text-[15px] text-foreground/80 leading-relaxed">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <strong className="text-[15px] text-foreground font-normal font-serif">No Boost Post Shortcuts</strong>
              <p className="text-[13px] text-foreground/60 leading-relaxed">
                We believe in running technical funnels, custom landing pages, pixel setups, and conversion marketing only.
              </p>
            </div>
          </div>
        </section>
